(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/AsyncSubject'), require('@angular/cdk/portal'), require('@angular/cdk/overlay'), require('@angular/cdk/a11y'), require('@angular/animations'), require('rxjs/Subject'), require('@angular/material'), require('@angular/common')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'rxjs/AsyncSubject', '@angular/cdk/portal', '@angular/cdk/overlay', '@angular/cdk/a11y', '@angular/animations', 'rxjs/Subject', '@angular/material', '@angular/common'], factory) :
	(factory((global.core = {}),global.ng.core,global.Rx,global.ng.cdk.portal,global.ng.cdk.overlay,global.ng.cdk.a11y,global.ng.animations,global.Rx,global.ng.material,global.ng.common));
}(this, (function (exports,core,AsyncSubject,portal,overlay,a11y,animations,Subject,material,common) { 'use strict';
...
})(exports.KeyboardState || (exports.KeyboardState = {}));
/**
 ...
 * @docs-private
 */
exports.MdKeyboardContainerComponent = /** @class */ (function (_super) {
    ...
    function MdKeyboardContainerComponent(_ngZone, _changeDetectorRef) {
        ...
        _this._animationState = exports.KeyboardState.Visible;
    ...
    MdKeyboardContainerComponent.prototype.onAnimationEnd = function (event) {
        if (event.toState === "" + exports.KeyboardState.Hidden || event.toState === "" + exports.KeyboardState.Hidden) {
            this._completeExit();
        }
        if (event.toState === "" + exports.KeyboardState.Visible) {
    ...
    MdKeyboardContainerComponent.prototype.enter = function () {
        if (!this._destroyed) {
            this._animationState = exports.KeyboardState.Visible;
    ...
    MdKeyboardContainerComponent.prototype.exit = function () {
        this._animationState = exports.KeyboardState.Hidden;
        return this._onExit();
    };
...
], exports.MdKeyboardContainerComponent.prototype, "attrRole", void 0);
__decorate$2([
    core.HostBinding('class.dark-theme'),
    core.Input(),
    __metadata$2("design:type", Boolean)
], exports.MdKeyboardContainerComponent.prototype, "darkTheme", void 0);
__decorate$2([
    core.ViewChild(portal.PortalHostDirective),
    __metadata$2("design:type", portal.PortalHostDirective)
], exports.MdKeyboardContainerComponent.prototype, "_portalHost", void 0);
__decorate$2([
    core.HostBinding('@state'),
    __metadata$2("design:type", Number)
], exports.MdKeyboardContainerComponent.prototype, "_animationState", void 0);
__decorate$2([
    core.HostListener('@state.done', ['$event']),
    __metadata$2("design:type", Function),
    __metadata$2("design:paramtypes", [Object]),
    __metadata$2("design:returntype", void 0)
], exports.MdKeyboardContainerComponent.prototype, "onAnimationEnd", null);
exports.MdKeyboardContainerComponent = __decorate$2([
    core.Component({
        ...
        animations: [
            animations.trigger('state', [
                animations.state("" + exports.KeyboardState.Visible, animations.style({ transform: 'translateY(0%)' })),
                animations.state("" + exports.KeyboardState.Hidden, animations.style({ transform: 'translateY(100%)' })),
                animations.transition(exports.KeyboardState.Visible + " => " + exports.KeyboardState.Hidden, animations.animate(HIDE_ANIMATION)),
                animations.transition(exports.KeyboardState.Void + " => " + exports.KeyboardState.Visible, animations.animate(SHOW_ANIMATION))
            ])
        ]
    }),
    __metadata$2("design:paramtypes", [core.NgZone,
        core.ChangeDetectorRef])
], exports.MdKeyboardContainerComponent);
...
var MdKeyboardRef = /** @class */ (function () {
    ...
    Object.defineProperty(MdKeyboardRef.prototype, "darkTheme", {
        get: function () {
            if (this.instance instanceof exports.MdKeyboardComponent) {
 ...
 */
exports.MdKeyboardService = /** @class */ (function () {
    ...
    MdKeyboardService.prototype.open = function (layoutOrLocale, config) {
        ...
        var _config = _applyConfigDefaults(config);
        var keyboardComponentRef = this._openFromComponent(exports.MdKeyboardComponent, _config);
    ...
    MdKeyboardService.prototype._attachKeyboardContainer = function (overlayRef, config) {
        var containerPortal = new portal.ComponentPortal(exports.MdKeyboardContainerComponent, config.viewContainerRef);
    ...
    MdKeyboardService.prototype._attachKeyboardContent = function (component, container, overlayRef) {
        var portal$$1 = new portal.ComponentPortal(component);
...
exports.MdKeyboardService = __decorate$1([
    core.Injectable(),
    __param$1(2, core.Inject(MD_KEYBOARD_LAYOUTS)),
    __param$1(3, core.Optional()), __param$1(3, core.SkipSelf()),
    __metadata$1("design:paramtypes", [overlay.Overlay,
        a11y.LiveAnnouncer, Object, exports.MdKeyboardService])
], exports.MdKeyboardService);
/**
 ...
 */
exports.MdKeyboardComponent = /** @class */ (function () {
    // Inject dependencies
    function MdKeyboardComponent(_locale, _keyboardService) {
        ...
        this.cssClass = true;
        this.isDebug = false;
        this.modifier = exports.KeyboardModifier.None;
    ...
    MdKeyboardComponent.prototype.isActive = function (key) {
        return this.modifier === exports.KeyboardModifier[key] || (this.modifier === exports.KeyboardModifier.ShiftAlt && exports.KeyboardModifier[key] > exports.KeyboardModifier.None);
    };
    MdKeyboardComponent.prototype.onAltClick = function () {
        if (this.modifier === exports.KeyboardModifier.None) {
            this.modifier = exports.KeyboardModifier.Alt;
        }
        else if (this.modifier === exports.KeyboardModifier.Shift) {
            this.modifier = exports.KeyboardModifier.ShiftAlt;
        }
        else if (this.modifier === exports.KeyboardModifier.ShiftAlt) {
            this.modifier = exports.KeyboardModifier.Shift;
        }
        else if (this.modifier === exports.KeyboardModifier.Alt) {
            this.modifier = exports.KeyboardModifier.None;
        }
    };
...
], exports.MdKeyboardComponent.prototype, "cssClass", void 0);
__decorate([
    core.HostBinding('class.dark-theme'),
    __metadata("design:type", Boolean)
], exports.MdKeyboardComponent.prototype, "darkTheme", void 0);
__decorate([
    core.HostBinding('class.has-action'),
    __metadata("design:type", Boolean)
], exports.MdKeyboardComponent.prototype, "hasAction", void 0);
__decorate([
    core.HostBinding('class.debug'),
    __metadata("design:type", Object)
], exports.MdKeyboardComponent.prototype, "isDebug", void 0);
exports.MdKeyboardComponent = __decorate([
    core.Component({
    ...
    __metadata("design:paramtypes", [Object, exports.MdKeyboardService])
], exports.MdKeyboardComponent);
...
})(exports.KeyboardKeyClass || (exports.KeyboardKeyClass = {}));
...
exports.MdKeyboardKeyComponent = /** @class */ (function () {
    // Inject dependencies
    ...
    Object.defineProperty(MdKeyboardKeyComponent.prototype, "isClassKey", {
        get: function () {
            return !!exports.KeyboardKeyClass[this.key];
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(MdKeyboardKeyComponent.prototype, "cssClass", {
        get: function () {
            ...
            if (this.isClassKey) {
                ...
                classes.push("mat-keyboard-key-" + exports.KeyboardKeyClass[this.key]);
            }
            if (this.isDeadKey) {
...
], exports.MdKeyboardKeyComponent.prototype, "key", void 0);
__decorate$3([
    core.Input(),
    __metadata$3("design:type", Boolean)
], exports.MdKeyboardKeyComponent.prototype, "active", void 0);
__decorate$3([
    core.Input(),
    __metadata$3("design:type", core.ElementRef)
], exports.MdKeyboardKeyComponent.prototype, "input", void 0);
__decorate$3([
    core.Input(),
    __metadata$3("design:type", material.MatInput)
], exports.MdKeyboardKeyComponent.prototype, "control", void 0);
__decorate$3([
    core.Output(),
    __metadata$3("design:type", Object)
], exports.MdKeyboardKeyComponent.prototype, "altClick", void 0);
__decorate$3([
    core.Output(),
    __metadata$3("design:type", Object)
], exports.MdKeyboardKeyComponent.prototype, "capsClick", void 0);
__decorate$3([
    core.Output(),
    __metadata$3("design:type", Object)
], exports.MdKeyboardKeyComponent.prototype, "shiftClick", void 0);
exports.MdKeyboardKeyComponent = __decorate$3([
    core.Component({
    ...
    __param$2(0, core.Inject(MD_KEYBOARD_DEADKEYS)),
    __param$2(1, core.Inject(MD_KEYBOARD_ICONS)),
    __metadata$3("design:paramtypes", [Object, Object])
], exports.MdKeyboardKeyComponent);
...
exports.MdKeyboardDirective = /** @class */ (function () {
...
], exports.MdKeyboardDirective.prototype, "mdKeyboard", void 0);
__decorate$4([
    core.Input(),
    __metadata$4("design:type", Boolean)
], exports.MdKeyboardDirective.prototype, "darkTheme", void 0);
__decorate$4([
    core.Input(),
    __metadata$4("design:type", Number)
], exports.MdKeyboardDirective.prototype, "duration", void 0);
__decorate$4([
    core.Input(),
    __metadata$4("design:type", Boolean)
], exports.MdKeyboardDirective.prototype, "hasAction", void 0);
__decorate$4([
    core.Input(),
    __metadata$4("design:type", Boolean)
], exports.MdKeyboardDirective.prototype, "isDebug", void 0);
__decorate$4([
    core.HostListener('focus', ['$event']),
    __metadata$4("design:type", Function),
    __metadata$4("design:paramtypes", []),
    __metadata$4("design:returntype", void 0)
], exports.MdKeyboardDirective.prototype, "_showKeyboard", null);
__decorate$4([
    core.HostListener('blur', ['$event']),
    __metadata$4("design:type", Function),
    __metadata$4("design:paramtypes", []),
    __metadata$4("design:returntype", void 0)
], exports.MdKeyboardDirective.prototype, "_hideKeyboard", null);
exports.MdKeyboardDirective = __decorate$4([
    core.Directive({
...
exports.KebabCasePipe = /** @class */ (function () {
...
exports.KebabCasePipe = __decorate$5([
    core.Pipe({
        name: 'kebabCase',
        pure: false
    })
...
exports.MdKeyboardModule = /** @class */ (function () {
    function MdKeyboardModule() {
    }
    return MdKeyboardModule;
}());
exports.MdKeyboardModule = __decorate$6([
    core.NgModule({
        imports: [
            common.CommonModule,
...
], exports.MdKeyboardModule);

exports.ɵe = exports.MdKeyboardContainerComponent;
exports.ɵg = exports.MdKeyboardKeyComponent;
exports.ɵa = exports.MdKeyboardComponent;
exports.ɵh = MD_KEYBOARD_DEADKEYS;
exports.ɵi = keyboardDeadkeys;
exports.ɵj = MD_KEYBOARD_ICONS;
exports.ɵk = keyboardIcons;
exports.ɵc = MD_KEYBOARD_LAYOUTS;
exports.ɵd = keyboardLayouts;
exports.ɵl = exports.MdKeyboardDirective;
exports.ɵf = exports.KeyboardState;
exports.ɵm = exports.KebabCasePipe;
exports.ɵb = exports.MdKeyboardService;
exports.SHOW_ANIMATION = SHOW_ANIMATION;
exports.HIDE_ANIMATION = HIDE_ANIMATION;
exports.MdKeyboardConfig = MdKeyboardConfig;
exports.MD_KEYBOARD_DEADKEYS = MD_KEYBOARD_DEADKEYS;
exports.keyboardDeadkeys = keyboardDeadkeys;
exports.MD_KEYBOARD_ICONS = MD_KEYBOARD_ICONS;
exports.keyboardIcons = keyboardIcons;
exports.keyboardLayouts = keyboardLayouts;
exports.MD_KEYBOARD_LAYOUTS = MD_KEYBOARD_LAYOUTS;
exports.throwContentAlreadyAttached = throwContentAlreadyAttached;
exports.throwLayoutNotFound = throwLayoutNotFound;
exports.MdKeyboardRef = MdKeyboardRef;
exports.ɵ0 = ɵ0;
exports.ɵ1 = ɵ1;
exports.ɵ2 = ɵ2;
